...
* @version   1.0
*
* @date      Wed Feb 27 13:21:48 ICT 2019
*
...
#define LIN_BYTE_OFFSET_LI0_Cluster1Potentiometer1    2U
#define LIN_BIT_OFFSET_LI0_Cluster1Potentiometer1    0U
#define LIN_SIGNAL_SIZE_LI0_Cluster1Potentiometer1    8U
#define LIN_FLAG_BYTE_OFFSET_LI0_Cluster1Potentiometer1    2U
#define LIN_FLAG_BIT_OFFSET_LI0_Cluster1Potentiometer1    0U


#define LIN_BYTE_OFFSET_LI0_Cluster1LightSensor1    3U
...
#define LIN_FLAG_BIT_OFFSET_LI0_Cluster1LightSensor1    1U


#define LIN_BYTE_OFFSET_LI0_Cluster1Slave1Error    4U
#define LIN_BIT_OFFSET_LI0_Cluster1Slave1Error    0U
#define LIN_SIGNAL_SIZE_LI0_Cluster1Slave1Error    1U
#define LIN_FLAG_BYTE_OFFSET_LI0_Cluster1Slave1Error    2U
#define LIN_FLAG_BIT_OFFSET_LI0_Cluster1Slave1Error    2U
...
#define LIN_FLAG_BYTE_OFFSET_LI0_Cluster1Slave1Info             2
#define LIN_FLAG_BIT_OFFSET_LI0_Cluster1Slave1Info              0
...
/* static access macros for signal LI0_Cluster1Slave1Error */

 
#define l_bool_rd_LI0_Cluster1Slave1Error() \
    (LIN_TEST_BIT(lin_pFrameBuf[LIN_BYTE_OFFSET_LI0_Cluster1Slave1Error], \
    LIN_BIT_OFFSET_LI0_Cluster1Slave1Error))

#define l_bool_wr_LI0_Cluster1Slave1Error(A) \
    {(A) ? \
    (LIN_SET_BIT(lin_pFrameBuf[LIN_BYTE_OFFSET_LI0_Cluster1Slave1Error], \
    LIN_BIT_OFFSET_LI0_Cluster1Slave1Error)):\
    (LIN_CLEAR_BIT(lin_pFrameBuf[LIN_BYTE_OFFSET_LI0_Cluster1Slave1Error], \
    LIN_BIT_OFFSET_LI0_Cluster1Slave1Error));\
    LIN_CLEAR_BIT(lin_flag_handle_tbl[LIN_FLAG_BYTE_OFFSET_LI0_Cluster1Slave1Error],\
         LIN_FLAG_BIT_OFFSET_LI0_Cluster1Slave1Error);}
...
#define l_flg_tst_LI0_Cluster1Slave1Error_flag() \
         LIN_TEST_BIT(lin_flag_handle_tbl[LIN_FLAG_BYTE_OFFSET_LI0_Cluster1Slave1Error],\
         LIN_FLAG_BIT_OFFSET_LI0_Cluster1Slave1Error)
#define l_flg_clr_LI0_Cluster1Slave1Error_flag() \
         LIN_CLEAR_BIT(lin_flag_handle_tbl[LIN_FLAG_BYTE_OFFSET_LI0_Cluster1Slave1Error],\
         LIN_FLAG_BIT_OFFSET_LI0_Cluster1Slave1Error)
...
/* Frame flag APIs */
 ...
 #define l_flg_tst_LI0_Cluster1Slave1Info_flag() \
          lin_frame_flag_tbl[LI0_Cluster1Slave1Info]
 #define l_flg_clr_LI0_Cluster1Slave1Info_flag() \
          lin_frame_flag_tbl[LI0_Cluster1Slave1Info] = 0
