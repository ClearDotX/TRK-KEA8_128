...
volatile PTVSTR _PTV;                                      /* Port V Data Register; 0x00000360 */
volatile PTIVSTR _PTIV;                                    /* Port V Input Register; 0x00000361 */
volatile DDRVSTR _DDRV;                                    /* Port V Data Direction Register; 0x00000362 */
volatile PERVSTR _PERV;                                    /* Port V Pull Device Enable Register; 0x00000363 */
volatile PPSVSTR _PPSV;                                    /* Port V Polarity Select Register; 0x00000364 */
volatile SRRVSTR _SRRV;                                    /* Port V Slew Rate Register; 0x0000036E */
...
volatile MCCC4STR _MCCC4;                                  /* Motor Controller Control Register 4; 0x00000A54 */
volatile MCCC5STR _MCCC5;                                  /* Motor Controller Control Register 5; 0x00000A55 */
volatile MCCC6STR _MCCC6;                                  /* Motor Controller Control Register 6; 0x00000A56 */
volatile MCCC7STR _MCCC7;                                  /* Motor Controller Control Register 7; 0x00000A57 */
...
volatile RTZ2CTLSTR _RTZ2CTL;                              /* SSD2 Return-to-Zero Control Register; 0x00000AA0 */
volatile MDC2CTLSTR _MDC2CTL;                              /* SSD2 Modulus Down Counter Control Register; 0x00000AA1 */
volatile SSD2CTLSTR _SSD2CTL;                              /* SSD2 Stepper Stall Detector Control Register; 0x00000AA2 */
volatile SSD2FLGSTR _SSD2FLG;                              /* SSD2 Stepper Stall Detector Flag Register; 0x00000AA3 */
volatile RTZ3CTLSTR _RTZ3CTL;                              /* SSD3 Return-to-Zero Control Register; 0x00000AB0 */
volatile MDC3CTLSTR _MDC3CTL;                              /* SSD3 Modulus Down Counter Control Register; 0x00000AB1 */
volatile SSD3CTLSTR _SSD3CTL;                              /* SSD3 Stepper Stall Detector Control Register; 0x00000AB2 */
volatile SSD3FLGSTR _SSD3FLG;                              /* SSD3 Stepper Stall Detector Flag Register; 0x00000AB3 */
...
volatile MCDC4STR _MCDC4;                                  /* Motor Controller Period Register 4; 0x00000A68 */
volatile MCDC5STR _MCDC5;                                  /* Motor Controller Period Register 5; 0x00000A6A */
volatile MCDC6STR _MCDC6;                                  /* Motor Controller Period Register 6; 0x00000A6C */
volatile MCDC7STR _MCDC7;                                  /* Motor Controller Period Register 7; 0x00000A6E */
...
volatile MDC2CNTSTR _MDC2CNT;                              /* SSD2 Modulus Down-Counter Count Register; 0x00000AA4 */
volatile ITG2ACCSTR _ITG2ACC;                              /* SSD2 Integration Accumulator Register; 0x00000AA6 */
volatile MDC3CNTSTR _MDC3CNT;                              /* SSD3 Modulus Down-Counter Count Register; 0x00000AB4 */
volatile ITG3ACCSTR _ITG3ACC;                              /* SSD3 Integration Accumulator Register; 0x00000AB6 */
