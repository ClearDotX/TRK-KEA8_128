...
volatile MODRR5STR _MODRR5;                                /* Module Routing Register 5; 0x00000205 */
...
volatile OCPETSTR _OCPET;                                  /* Port T Over-Current Protection Enable Register; 0x000002C9 */
volatile OCIETSTR _OCIET;                                  /* Port T Over-Current Interrupt Enable Register; 0x000002CA */
volatile OCIFTSTR _OCIFT;                                  /* Port T Over-Current Interrupt Flag Register; 0x000002CB */
volatile RDRTSTR _RDRT;                                    /* Port T Reduced Drive Register; 0x000002CD */
...
volatile HSDRSTR _HSDR;                                    /* Port HS Data Register; 0x000009C0 */
volatile HSCRSTR _HSCR;                                    /* HSDRV Configuration Register; 0x000009C1 */
volatile HSSLRSTR _HSSLR;                                  /* HSDRV Slew Rate Control Register; 0x000009C2 */
volatile HSSRSTR _HSSR;                                    /* HSDRV Status Register; 0x000009C5 */
volatile HSIESTR _HSIE;                                    /* HSDRV Interrupt Enable Register; 0x000009C6 */
volatile HSIFSTR _HSIF;                                    /* HSDRV Interrupt Flag Register; 0x000009C7 */
