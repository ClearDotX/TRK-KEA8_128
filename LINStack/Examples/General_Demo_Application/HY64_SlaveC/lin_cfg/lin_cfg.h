...
* @version   1.0
*
* @date      Wed Feb 27 13:21:54 ICT 2019
*
...
#define LIN_BYTE_OFFSET_LI0_Cluster2PotentiometerC    2U
#define LIN_BIT_OFFSET_LI0_Cluster2PotentiometerC    0U
#define LIN_SIGNAL_SIZE_LI0_Cluster2PotentiometerC    8U
#define LIN_FLAG_BYTE_OFFSET_LI0_Cluster2PotentiometerC    2U
#define LIN_FLAG_BIT_OFFSET_LI0_Cluster2PotentiometerC    0U


#define LIN_BYTE_OFFSET_LI0_Cluster2SlaveCError    3U
#define LIN_BIT_OFFSET_LI0_Cluster2SlaveCError    0U
#define LIN_SIGNAL_SIZE_LI0_Cluster2SlaveCError    1U
#define LIN_FLAG_BYTE_OFFSET_LI0_Cluster2SlaveCError    2U
#define LIN_FLAG_BIT_OFFSET_LI0_Cluster2SlaveCError    1U
...
#define LIN_FLAG_BYTE_OFFSET_LI0_Cluster2SlaveCInfo             2
#define LIN_FLAG_BIT_OFFSET_LI0_Cluster2SlaveCInfo              0
...
/* static access macros for signal LI0_Cluster2SlaveCError */

 
#define l_bool_rd_LI0_Cluster2SlaveCError() \
    (LIN_TEST_BIT(lin_pFrameBuf[LIN_BYTE_OFFSET_LI0_Cluster2SlaveCError], \
    LIN_BIT_OFFSET_LI0_Cluster2SlaveCError))

#define l_bool_wr_LI0_Cluster2SlaveCError(A) \
    {(A) ? \
    (LIN_SET_BIT(lin_pFrameBuf[LIN_BYTE_OFFSET_LI0_Cluster2SlaveCError], \
    LIN_BIT_OFFSET_LI0_Cluster2SlaveCError)):\
    (LIN_CLEAR_BIT(lin_pFrameBuf[LIN_BYTE_OFFSET_LI0_Cluster2SlaveCError], \
    LIN_BIT_OFFSET_LI0_Cluster2SlaveCError));\
    LIN_CLEAR_BIT(lin_flag_handle_tbl[LIN_FLAG_BYTE_OFFSET_LI0_Cluster2SlaveCError],\
         LIN_FLAG_BIT_OFFSET_LI0_Cluster2SlaveCError);}
...
#define l_flg_tst_LI0_Cluster2SlaveCError_flag() \
         LIN_TEST_BIT(lin_flag_handle_tbl[LIN_FLAG_BYTE_OFFSET_LI0_Cluster2SlaveCError],\
         LIN_FLAG_BIT_OFFSET_LI0_Cluster2SlaveCError)
#define l_flg_clr_LI0_Cluster2SlaveCError_flag() \
         LIN_CLEAR_BIT(lin_flag_handle_tbl[LIN_FLAG_BYTE_OFFSET_LI0_Cluster2SlaveCError],\
         LIN_FLAG_BIT_OFFSET_LI0_Cluster2SlaveCError)
...
/* Frame flag APIs */
 ...
 #define l_flg_tst_LI0_Cluster2SlaveCInfo_flag() \
          lin_frame_flag_tbl[LI0_Cluster2SlaveCInfo]
 #define l_flg_clr_LI0_Cluster2SlaveCInfo_flag() \
          lin_frame_flag_tbl[LI0_Cluster2SlaveCInfo] = 0
