...
* @version   1.0
*
* @date      Thu Mar 07 09:55:25 ICT 2019
*
...
const l_signal_handle LI0_response_error_signal = LI0_Motor2LinError;
...
l_u8    lin_pFrameBuf[LIN_FRAME_BUF_SIZE] =
{
  ...
  0x00 /* 0 : 00000000 */ /* start of frame LI0_MotorsControl */

  ,0xf0 /* 1 : 11110000 */


  ,0xfc /* 2 : 11111100 */ /* start of frame LI0_Motor2Control */


  ,0x00 /* 3 : 00000000 */ /* start of frame LI0_Motor2State_Cycl */
  ...
  ,0x37 /* 9 : 00110111 */ /* start of frame LI0_Motor2State_Event */
...
l_u8    lin_flag_handle_tbl[LIN_FLAG_BUF_SIZE] =
{
  ...
  ,0xFF /* 1: start of flag frame LI0_Motor2Control */


  ,0xFF /* 2: start of flag frame LI0_Motor2State_Cycl */


  ,0xFF /* 3: start of flag frame LI0_Motor2State_Event */
...
const l_u8 LI0_ETF_MotorStates_info_data = LI0_Motor2State_Event ;  /* frame data */
...
const lin_frame_struct lin_frame_tbl[LIN_NUM_OF_FRMS] ={
   ...
   ,{ LIN_FRM_UNCD, 1, LIN_RES_SUB, 2, 1, 1 , (l_u8*)0 }
  
   ,{ LIN_FRM_UNCD, 6, LIN_RES_PUB, 3, 2, 1 , (l_u8*)&LI0_response_error_signal }
  
   ,{ LIN_FRM_UNCD, 3, LIN_RES_PUB, 9, 3, 1 , (l_u8*)0 }
...
l_u8 lin_configuration_RAM[LIN_SIZE_OF_CFG]= {0x00, 0x2D, 0x31, 0x34, 0x37, 0x3A, 0x3C, 0x3D ,0xFF};


const l_u16  lin_configuration_ROM[LIN_SIZE_OF_CFG]= {0x00, 0x2D, 0x31, 0x34, 0x37, 0x3A, 0x3C, 0x3D ,0xFFFF};

/***************************************** Node Attribute*****************************************/

l_u8 lin_configured_NAD = 0x03;    /*<configured_NAD>*/
const l_u8 lin_initial_NAD    =0x0C;    /*<initial_NAD>*/
const lin_product_id product_id = {0x002E, 0x000B, 0x0001 };  /* {<supplier_id>,<function_id>,<variant>} */
const l_signal_handle response_error =  LI0_Motor2LinError;
const l_u8 num_frame_have_esignal = 1;                                 /*number of frame contain error signal*/
const l_u16 lin_response_error_byte_offset[1] = {LIN_BYTE_OFFSET_LI0_Motor2LinError};                  /*<interface_name>_< response_error>*/
const l_u8 lin_response_error_bit_offset[1] = {LIN_BIT_OFFSET_LI0_Motor2LinError};                  /*<interface_name>_< response_error>*/
