...
#define _DIAG_NUMBER_OF_SERVICES_    12

#define DIAGSRV_READ_BY_IDENTIFIER_ORDER    0

#define DIAGSRV_WRITE_DATA_BY_IDENTIFIER_ORDER    1

#define DIAGSRV_SESSION_CONTROL_ORDER    2

#define DIAGSRV_IO_CONTROL_BY_IDENTIFIER_ORDER    3

#define DIAGSRV_FAULT_MEMORY_READ_ORDER    4

#define DIAGSRV_FAULT_MEMORY_CLEAR_ORDER    5

#define DIAGSRV_ASSIGN_FRAME_ID_RANGE_ORDER    6

#define DIAGSRV_ASSIGN_NAD_ORDER    7

#define DIAGSRV_CONDITIONAL_CHANGE_NAD_ORDER    8

#define DIAGSRV_SAVE_CONFIGURATION_ORDER    9

#define DIAGSRV_ASSIGN_FRAME_IDENTIFIER_ORDER    10

#define DIAGSRV_READ_DATA_BY_IDENTIFIER_ORDER    11
