...
const l_signal_handle LI0_response_error_signal = LI0_Cluster2SlaveAError;
...
l_u8    lin_pFrameBuf[LIN_FRAME_BUF_SIZE] =
{
  ...
  ,0x00 /* 2 : 00000000 */ /* start of frame LI0_Cluster2SlaveAInfo */
...
l_u8    lin_flag_handle_tbl[LIN_FLAG_BUF_SIZE] =
{
  ...
  ,0xFF /* 2: start of flag frame LI0_Cluster2SlaveAInfo */
...
const lin_frame_struct lin_frame_tbl[LIN_NUM_OF_FRMS] ={
   ...
   ,{ LIN_FRM_UNCD, 3, LIN_RES_PUB, 2, 2, 1 , (l_u8*)&LI0_response_error_signal }
...
l_u8 lin_configuration_RAM[LIN_SIZE_OF_CFG]= {0x00, 0x09, 0x08, 0x0B, 0x3C, 0x3D ,0xFF};


const l_u16  lin_configuration_ROM[LIN_SIZE_OF_CFG]= {0x00, 0x09, 0x08, 0x0B, 0x3C, 0x3D ,0xFFFF};

/***************************************** Node Attribute*****************************************/

l_u8 lin_configured_NAD = 0x04;    /*<configured_NAD>*/
const l_u8 lin_initial_NAD    =0x0D;    /*<initial_NAD>*/
const lin_product_id product_id = {0x0021, 0x0004, 0x0003 };  /* {<supplier_id>,<function_id>,<variant>} */
const l_signal_handle response_error =  LI0_Cluster2SlaveAError;
const l_u8 num_frame_have_esignal = 1;                                 /*number of frame contain error signal*/
const l_u16 lin_response_error_byte_offset[1] = {LIN_BYTE_OFFSET_LI0_Cluster2SlaveAError};                  /*<interface_name>_< response_error>*/
const l_u8 lin_response_error_bit_offset[1] = {LIN_BIT_OFFSET_LI0_Cluster2SlaveAError};                  /*<interface_name>_< response_error>*/
