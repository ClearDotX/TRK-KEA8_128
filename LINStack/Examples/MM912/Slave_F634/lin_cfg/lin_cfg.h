...
#define LIN_FLAG_BYTE_OFFSET_LI0_Motor2Control             1
#define LIN_FLAG_BIT_OFFSET_LI0_Motor2Control              0

#define LIN_FLAG_BYTE_OFFSET_LI0_Motor2State_Cycl             2
#define LIN_FLAG_BIT_OFFSET_LI0_Motor2State_Cycl              0

#define LIN_FLAG_BYTE_OFFSET_LI0_Motor2State_Event             3
