...
volatile SLCC1STR _SLCC1;                                  /* SLIC Control Register 1; 0x00000070 */
volatile SLCC2STR _SLCC2;                                  /* SLIC Control Register 2; 0x00000071 */
volatile SLCSSTR _SLCS;                                    /* SLIC Status Register; 0x00000074 */
volatile SLCSVSTR _SLCSV;                                  /* SLIC State Vector Register; 0x00000075 */
volatile SLCDLCSTR _SLCDLC;                                /* SLIC Data Length Code Register; 0x00000076 */
volatile SLCIDSTR _SLCID;                                  /* SLIC Identifier Register; 0x00000077 */
volatile SLCD0STR _SLCD0;                                  /* SLIC Data Register 0; 0x00000078 */
volatile SLCD1STR _SLCD1;                                  /* SLIC Data Register 1; 0x00000079 */
volatile SLCD2STR _SLCD2;                                  /* SLIC Data Register 2; 0x0000007A */
volatile SLCD3STR _SLCD3;                                  /* SLIC Data Register 3; 0x0000007B */
volatile SLCD4STR _SLCD4;                                  /* SLIC Data Register 4; 0x0000007C */
volatile SLCD5STR _SLCD5;                                  /* SLIC Data Register 5; 0x0000007D */
volatile SLCD6STR _SLCD6;                                  /* SLIC Data Register 6; 0x0000007E */
volatile SLCD7STR _SLCD7;                                  /* SLIC Data Register 7; 0x0000007F */
...
volatile PTCSCSTR _PTCSC;                                  /* Port C Interrupt Status and Control Register; 0x00001854 */
volatile PTCPSSTR _PTCPS;                                  /* Port C Interrupt Pin Select Register; 0x00001855 */
volatile PTCESSTR _PTCES;                                  /* Port C Interrupt Edge Select Register; 0x00001856 */
...
volatile SLCBTSTR _SLCBT;                                  /* SLIC Bit Time Register; 0x00000072 */
