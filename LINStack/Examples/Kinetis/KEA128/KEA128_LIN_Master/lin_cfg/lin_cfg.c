...
* @version   1.0
*
* @date      Thu Mar 07 09:55:21 ICT 2019
*
...
const lin_hardware_name lin_virtual_ifc[LIN_NUM_OF_IFCS] = {LINUART0};
...
const lin_schedule_data LI0_InitTable_data[8] = {
   ...
   {LI0_MasterReq, 4, {0x0A,0x06,0xB0,0x1E,0x00,0x01,0x00,0x02}}
  

   , {LI0_SlaveResp, 4, 0}
  
   , {LI0_MasterReq, 4, {0x0C,0x06,0xB0,0x2E,0x00,0x0B,0x00,0x03}}
  
   , {LI0_SlaveResp, 4, 0}
  
   , {LI0_MasterReq, 4, {0x02,0x06,0xB7,0x00,0xAD,0xF0,0x73,0x76}}
  
   , {LI0_MasterReq, 4, {0x02,0x06,0xB7,0x04,0xBA,0xFF,0xFF,0xFF}}
  
   , {LI0_MasterReq, 4, {0x03,0x06,0xB7,0x00,0xAD,0xB1,0xB4,0x37}}
  
   , {LI0_MasterReq, 4, {0x03,0x06,0xB7,0x04,0xBA,0xFF,0xFF,0xFF}}
