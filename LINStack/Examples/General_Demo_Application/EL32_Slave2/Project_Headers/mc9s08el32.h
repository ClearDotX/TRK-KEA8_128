/* Based on CPU DB MC9S08EL32_28, version 3.00.059 (RegistersPrg V2.32) */
/*
** ###################################################################
**     Filename  : mc9s08el32.h
**     Processor : MC9S08EL32MTL
**     FileFormat: V2.32
**     DataSheet : MC9S08EL32 Rev. 3 7/2008
...
#ifndef _MC9S08EL32_H
#define _MC9S08EL32_H
...
/*** SLCC1 - SLIC Control Register 1; 0x00000070 ***/
typedef union {
  byte Byte;
  struct {
    ...
    byte BEDD        :1;                                       /* BEDD Bit Error Detection Disable */
    byte INITREQ     :1;                                       /* Initialization Request */
    byte             :1; 
    byte             :1; 
  } Bits;
} SLCC1STR;
extern volatile SLCC1STR _SLCC1 @0x00000070;
...
#define SLCC1_BEDD                      _SLCC1.Bits.BEDD
#define SLCC1_INITREQ                   _SLCC1.Bits.INITREQ

#define SLCC1_SLCIE_MASK                1U
#define SLCC1_IMSG_MASK                 2U
#define SLCC1_TXABRT_MASK               4U
#define SLCC1_WAKETX_MASK               8U
#define SLCC1_BEDD_MASK                 16U
#define SLCC1_INITREQ_MASK              32U


/*** SLCC2 - SLIC Control Register 2; 0x00000071 ***/
typedef union {
  byte Byte;
  struct {
    byte SLCE        :1;                                       /* SLIC Module Enable */
    byte             :1; 
    byte BTM         :1;                                       /* UART Byte Transfer Mode */
    byte SLCWCM      :1;                                       /* SLIC Wait Clock Mode */
    byte RXFP0       :1;                                       /* Receive Filter Prescaler Bit0 */
    byte RXFP1       :1;                                       /* Receive Filter Prescaler Bit1 */
    byte RXFP2       :1;                                       /* Receive Filter Prescaler Bit2 */
    byte             :1; 
  } Bits;
  struct {
    byte         :1;
...
extern volatile SLCC2STR _SLCC2 @0x00000071;
#define SLCC2                           _SLCC2.Byte
#define SLCC2_SLCE                      _SLCC2.Bits.SLCE
#define SLCC2_BTM                       _SLCC2.Bits.BTM
#define SLCC2_SLCWCM                    _SLCC2.Bits.SLCWCM
#define SLCC2_RXFP0                     _SLCC2.Bits.RXFP0
#define SLCC2_RXFP1                     _SLCC2.Bits.RXFP1
#define SLCC2_RXFP2                     _SLCC2.Bits.RXFP2
#define SLCC2_RXFP                      _SLCC2.MergedBits.grpRXFP

#define SLCC2_SLCE_MASK                 1U
#define SLCC2_BTM_MASK                  4U
#define SLCC2_SLCWCM_MASK               8U
#define SLCC2_RXFP0_MASK                16U
#define SLCC2_RXFP1_MASK                32U
#define SLCC2_RXFP2_MASK                64U
#define SLCC2_RXFP_MASK                 112U
#define SLCC2_RXFP_BITNUM               4U


/*** SLCBT - SLIC Bit Time Register; 0x00000072 ***/
typedef union {
  word Word;
   /* Overlapped registers: */
  struct {
    /*** SLCBTH - SLIC Bit Time Register High; 0x00000072 ***/
    union {
      byte Byte;
      struct {
        byte BT8         :1;                                       /* Bit Time Value Bit 8 */
        byte BT9         :1;                                       /* Bit Time Value Bit 9 */
        byte BT10        :1;                                       /* Bit Time Value Bit 10 */
        byte BT11        :1;                                       /* Bit Time Value Bit 11 */
        byte BT12        :1;                                       /* Bit Time Value Bit 12 */
        byte BT13        :1;                                       /* Bit Time Value Bit 13 */
        byte BT14        :1;                                       /* Bit Time Value Bit 14 */
        byte             :1; 
      } Bits;
      struct {
        byte grpBT_8 :7;
    ...
    #define SLCBTH                      _SLCBT.Overlap_STR.SLCBTHSTR.Byte
    #define SLCBTH_BT8                  _SLCBT.Overlap_STR.SLCBTHSTR.Bits.BT8
    #define SLCBTH_BT9                  _SLCBT.Overlap_STR.SLCBTHSTR.Bits.BT9
    #define SLCBTH_BT10                 _SLCBT.Overlap_STR.SLCBTHSTR.Bits.BT10
    #define SLCBTH_BT11                 _SLCBT.Overlap_STR.SLCBTHSTR.Bits.BT11
    #define SLCBTH_BT12                 _SLCBT.Overlap_STR.SLCBTHSTR.Bits.BT12
    #define SLCBTH_BT13                 _SLCBT.Overlap_STR.SLCBTHSTR.Bits.BT13
    #define SLCBTH_BT14                 _SLCBT.Overlap_STR.SLCBTHSTR.Bits.BT14
    #define SLCBTH_BT_8                 _SLCBT.Overlap_STR.SLCBTHSTR.MergedBits.grpBT_8
    #define SLCBTH_BT                   SLCBTH_BT_8
    
    #define SLCBTH_BT8_MASK             1U
    #define SLCBTH_BT9_MASK             2U
    #define SLCBTH_BT10_MASK            4U
    #define SLCBTH_BT11_MASK            8U
    #define SLCBTH_BT12_MASK            16U
    #define SLCBTH_BT13_MASK            32U
    #define SLCBTH_BT14_MASK            64U
    #define SLCBTH_BT_8_MASK            127U
    #define SLCBTH_BT_8_BITNUM          0U
    

    /*** SLCBTL - SLIC Bit Time Register Low; 0x00000073 ***/
    union {
      byte Byte;
      struct {
        byte BT0         :1;                                       /* Bit Time Value Bit 0 */
        byte BT1         :1;                                       /* Bit Time Value Bit 1 */
        byte BT2         :1;                                       /* Bit Time Value Bit 2 */
        byte BT3         :1;                                       /* Bit Time Value Bit 3 */
        byte BT4         :1;                                       /* Bit Time Value Bit 4 */
        byte BT5         :1;                                       /* Bit Time Value Bit 5 */
        byte BT6         :1;                                       /* Bit Time Value Bit 6 */
        byte BT7         :1;                                       /* Bit Time Value Bit 7 */
      } Bits;
    } SLCBTLSTR;
    #define SLCBTL                      _SLCBT.Overlap_STR.SLCBTLSTR.Byte
    #define SLCBTL_BT0                  _SLCBT.Overlap_STR.SLCBTLSTR.Bits.BT0
    #define SLCBTL_BT1                  _SLCBT.Overlap_STR.SLCBTLSTR.Bits.BT1
    #define SLCBTL_BT2                  _SLCBT.Overlap_STR.SLCBTLSTR.Bits.BT2
    #define SLCBTL_BT3                  _SLCBT.Overlap_STR.SLCBTLSTR.Bits.BT3
    #define SLCBTL_BT4                  _SLCBT.Overlap_STR.SLCBTLSTR.Bits.BT4
    #define SLCBTL_BT5                  _SLCBT.Overlap_STR.SLCBTLSTR.Bits.BT5
    #define SLCBTL_BT6                  _SLCBT.Overlap_STR.SLCBTLSTR.Bits.BT6
    #define SLCBTL_BT7                  _SLCBT.Overlap_STR.SLCBTLSTR.Bits.BT7
    
    #define SLCBTL_BT0_MASK             1U
    #define SLCBTL_BT1_MASK             2U
    #define SLCBTL_BT2_MASK             4U
    #define SLCBTL_BT3_MASK             8U
    #define SLCBTL_BT4_MASK             16U
    #define SLCBTL_BT5_MASK             32U
    #define SLCBTL_BT6_MASK             64U
    #define SLCBTL_BT7_MASK             128U
    
  } Overlap_STR;

} SLCBTSTR;
extern volatile SLCBTSTR _SLCBT @0x00000072;
#define SLCBT                           _SLCBT.Word


/*** SLCS - SLIC Status Register; 0x00000074 ***/
typedef union {
  byte Byte;
  struct {
...
extern volatile SLCSSTR _SLCS @0x00000074;
...
#define SLCS_SLCF_MASK                  1U
#define SLCS_INITACK_MASK               32U
#define SLCS_SLCACT_MASK                128U


/*** SLCSV - SLIC State Vector Register; 0x00000075 ***/
typedef union {
  byte Byte;
  struct {
    byte             :1; 
...
extern volatile SLCSVSTR _SLCSV @0x00000075;
...
#define SLCSV_I                         _SLCSV.MergedBits.grpI

#define SLCSV_I0_MASK                   4U
#define SLCSV_I1_MASK                   8U
#define SLCSV_I2_MASK                   16U
#define SLCSV_I3_MASK                   32U
#define SLCSV_I_MASK                    60U
#define SLCSV_I_BITNUM                  2U


/*** SLCDLC - SLIC Data Length Code Register; 0x00000076 ***/
typedef union {
  byte Byte;
  struct {
...
extern volatile SLCDLCSTR _SLCDLC @0x00000076;
...
#define SLCDLC_DLC                      _SLCDLC.MergedBits.grpDLC

#define SLCDLC_DLC0_MASK                1U
#define SLCDLC_DLC1_MASK                2U
#define SLCDLC_DLC2_MASK                4U
#define SLCDLC_DLC3_MASK                8U
#define SLCDLC_DLC4_MASK                16U
#define SLCDLC_DLC5_MASK                32U
#define SLCDLC_CHKMOD_MASK              64U
#define SLCDLC_TXGO_MASK                128U
#define SLCDLC_DLC_MASK                 63U
#define SLCDLC_DLC_BITNUM               0U


/*** SLCID - SLIC Identifier Register; 0x00000077 ***/
typedef union {
  byte Byte;
  struct {
    byte R0_T0       :1;                                       /* Receive/Transmit Data Bit 0 */
...
extern volatile SLCIDSTR _SLCID @0x00000077;
#define SLCID                           _SLCID.Byte
#define SLCID_R0_T0                     _SLCID.Bits.R0_T0
#define SLCID_R1_T1                     _SLCID.Bits.R1_T1
#define SLCID_R2_T2                     _SLCID.Bits.R2_T2
#define SLCID_R3_T3                     _SLCID.Bits.R3_T3
#define SLCID_R4_T4                     _SLCID.Bits.R4_T4
#define SLCID_R5_T5                     _SLCID.Bits.R5_T5
#define SLCID_R6_T6                     _SLCID.Bits.R6_T6
#define SLCID_R7_T7                     _SLCID.Bits.R7_T7

#define SLCID_R0_T0_MASK                1U
#define SLCID_R1_T1_MASK                2U
#define SLCID_R2_T2_MASK                4U
#define SLCID_R3_T3_MASK                8U
#define SLCID_R4_T4_MASK                16U
#define SLCID_R5_T5_MASK                32U
#define SLCID_R6_T6_MASK                64U
#define SLCID_R7_T7_MASK                128U


/*** SLCD0 - SLIC Data Register 0; 0x00000078 ***/
typedef union {
  byte Byte;
  struct {
    byte R0_T0       :1;                                       /* Receive/Transmit Data Bit 0 */
...
extern volatile SLCD0STR _SLCD0 @0x00000078;
#define SLCD0                           _SLCD0.Byte
#define SLCD0_R0_T0                     _SLCD0.Bits.R0_T0
#define SLCD0_R1_T1                     _SLCD0.Bits.R1_T1
#define SLCD0_R2_T2                     _SLCD0.Bits.R2_T2
#define SLCD0_R3_T3                     _SLCD0.Bits.R3_T3
#define SLCD0_R4_T4                     _SLCD0.Bits.R4_T4
#define SLCD0_R5_T5                     _SLCD0.Bits.R5_T5
#define SLCD0_R6_T6                     _SLCD0.Bits.R6_T6
#define SLCD0_R7_T7                     _SLCD0.Bits.R7_T7
/* SLCD_ARR: Access 8 SLCDx registers in an array */
#define SLCD_ARR                        ((volatile byte * __far) &SLCD0)

#define SLCD0_R0_T0_MASK                1U
#define SLCD0_R1_T1_MASK                2U
#define SLCD0_R2_T2_MASK                4U
#define SLCD0_R3_T3_MASK                8U
#define SLCD0_R4_T4_MASK                16U
#define SLCD0_R5_T5_MASK                32U
#define SLCD0_R6_T6_MASK                64U
#define SLCD0_R7_T7_MASK                128U


/*** SLCD1 - SLIC Data Register 1; 0x00000079 ***/
typedef union {
  byte Byte;
  struct {
    byte R0_T0       :1;                                       /* Receive/Transmit Data Bit 0 */
...
extern volatile SLCD1STR _SLCD1 @0x00000079;
#define SLCD1                           _SLCD1.Byte
#define SLCD1_R0_T0                     _SLCD1.Bits.R0_T0
#define SLCD1_R1_T1                     _SLCD1.Bits.R1_T1
#define SLCD1_R2_T2                     _SLCD1.Bits.R2_T2
#define SLCD1_R3_T3                     _SLCD1.Bits.R3_T3
#define SLCD1_R4_T4                     _SLCD1.Bits.R4_T4
#define SLCD1_R5_T5                     _SLCD1.Bits.R5_T5
#define SLCD1_R6_T6                     _SLCD1.Bits.R6_T6
#define SLCD1_R7_T7                     _SLCD1.Bits.R7_T7

#define SLCD1_R0_T0_MASK                1U
#define SLCD1_R1_T1_MASK                2U
#define SLCD1_R2_T2_MASK                4U
#define SLCD1_R3_T3_MASK                8U
#define SLCD1_R4_T4_MASK                16U
#define SLCD1_R5_T5_MASK                32U
#define SLCD1_R6_T6_MASK                64U
#define SLCD1_R7_T7_MASK                128U


/*** SLCD2 - SLIC Data Register 2; 0x0000007A ***/
typedef union {
  byte Byte;
  struct {
    byte R0_T0       :1;                                       /* Receive/Transmit Data Bit 0 */
...
extern volatile SLCD2STR _SLCD2 @0x0000007A;
#define SLCD2                           _SLCD2.Byte
#define SLCD2_R0_T0                     _SLCD2.Bits.R0_T0
#define SLCD2_R1_T1                     _SLCD2.Bits.R1_T1
#define SLCD2_R2_T2                     _SLCD2.Bits.R2_T2
#define SLCD2_R3_T3                     _SLCD2.Bits.R3_T3
#define SLCD2_R4_T4                     _SLCD2.Bits.R4_T4
#define SLCD2_R5_T5                     _SLCD2.Bits.R5_T5
#define SLCD2_R6_T6                     _SLCD2.Bits.R6_T6
#define SLCD2_R7_T7                     _SLCD2.Bits.R7_T7

#define SLCD2_R0_T0_MASK                1U
#define SLCD2_R1_T1_MASK                2U
#define SLCD2_R2_T2_MASK                4U
#define SLCD2_R3_T3_MASK                8U
#define SLCD2_R4_T4_MASK                16U
#define SLCD2_R5_T5_MASK                32U
#define SLCD2_R6_T6_MASK                64U
#define SLCD2_R7_T7_MASK                128U


/*** SLCD3 - SLIC Data Register 3; 0x0000007B ***/
typedef union {
  byte Byte;
  struct {
    byte R0_T0       :1;                                       /* Receive/Transmit Data Bit 0 */
...
extern volatile SLCD3STR _SLCD3 @0x0000007B;
#define SLCD3                           _SLCD3.Byte
#define SLCD3_R0_T0                     _SLCD3.Bits.R0_T0
#define SLCD3_R1_T1                     _SLCD3.Bits.R1_T1
#define SLCD3_R2_T2                     _SLCD3.Bits.R2_T2
#define SLCD3_R3_T3                     _SLCD3.Bits.R3_T3
#define SLCD3_R4_T4                     _SLCD3.Bits.R4_T4
#define SLCD3_R5_T5                     _SLCD3.Bits.R5_T5
#define SLCD3_R6_T6                     _SLCD3.Bits.R6_T6
#define SLCD3_R7_T7                     _SLCD3.Bits.R7_T7

#define SLCD3_R0_T0_MASK                1U
#define SLCD3_R1_T1_MASK                2U
#define SLCD3_R2_T2_MASK                4U
#define SLCD3_R3_T3_MASK                8U
#define SLCD3_R4_T4_MASK                16U
#define SLCD3_R5_T5_MASK                32U
#define SLCD3_R6_T6_MASK                64U
#define SLCD3_R7_T7_MASK                128U


/*** SLCD4 - SLIC Data Register 4; 0x0000007C ***/
typedef union {
  byte Byte;
  struct {
    byte R0_T0       :1;                                       /* Receive/Transmit Data Bit 0 */
...
extern volatile SLCD4STR _SLCD4 @0x0000007C;
#define SLCD4                           _SLCD4.Byte
#define SLCD4_R0_T0                     _SLCD4.Bits.R0_T0
#define SLCD4_R1_T1                     _SLCD4.Bits.R1_T1
#define SLCD4_R2_T2                     _SLCD4.Bits.R2_T2
#define SLCD4_R3_T3                     _SLCD4.Bits.R3_T3
#define SLCD4_R4_T4                     _SLCD4.Bits.R4_T4
#define SLCD4_R5_T5                     _SLCD4.Bits.R5_T5
#define SLCD4_R6_T6                     _SLCD4.Bits.R6_T6
#define SLCD4_R7_T7                     _SLCD4.Bits.R7_T7

#define SLCD4_R0_T0_MASK                1U
#define SLCD4_R1_T1_MASK                2U
#define SLCD4_R2_T2_MASK                4U
#define SLCD4_R3_T3_MASK                8U
#define SLCD4_R4_T4_MASK                16U
#define SLCD4_R5_T5_MASK                32U
#define SLCD4_R6_T6_MASK                64U
#define SLCD4_R7_T7_MASK                128U


/*** SLCD5 - SLIC Data Register 5; 0x0000007D ***/
typedef union {
  byte Byte;
  struct {
    byte R0_T0       :1;                                       /* Receive/Transmit Data Bit 0 */
...
extern volatile SLCD5STR _SLCD5 @0x0000007D;
#define SLCD5                           _SLCD5.Byte
#define SLCD5_R0_T0                     _SLCD5.Bits.R0_T0
#define SLCD5_R1_T1                     _SLCD5.Bits.R1_T1
#define SLCD5_R2_T2                     _SLCD5.Bits.R2_T2
#define SLCD5_R3_T3                     _SLCD5.Bits.R3_T3
#define SLCD5_R4_T4                     _SLCD5.Bits.R4_T4
#define SLCD5_R5_T5                     _SLCD5.Bits.R5_T5
#define SLCD5_R6_T6                     _SLCD5.Bits.R6_T6
#define SLCD5_R7_T7                     _SLCD5.Bits.R7_T7

#define SLCD5_R0_T0_MASK                1U
#define SLCD5_R1_T1_MASK                2U
#define SLCD5_R2_T2_MASK                4U
#define SLCD5_R3_T3_MASK                8U
#define SLCD5_R4_T4_MASK                16U
#define SLCD5_R5_T5_MASK                32U
#define SLCD5_R6_T6_MASK                64U
#define SLCD5_R7_T7_MASK                128U


/*** SLCD6 - SLIC Data Register 6; 0x0000007E ***/
typedef union {
  byte Byte;
  struct {
    byte R0_T0       :1;                                       /* Receive/Transmit Data Bit 0 */
...
extern volatile SLCD6STR _SLCD6 @0x0000007E;
#define SLCD6                           _SLCD6.Byte
#define SLCD6_R0_T0                     _SLCD6.Bits.R0_T0
#define SLCD6_R1_T1                     _SLCD6.Bits.R1_T1
#define SLCD6_R2_T2                     _SLCD6.Bits.R2_T2
#define SLCD6_R3_T3                     _SLCD6.Bits.R3_T3
#define SLCD6_R4_T4                     _SLCD6.Bits.R4_T4
#define SLCD6_R5_T5                     _SLCD6.Bits.R5_T5
#define SLCD6_R6_T6                     _SLCD6.Bits.R6_T6
#define SLCD6_R7_T7                     _SLCD6.Bits.R7_T7

#define SLCD6_R0_T0_MASK                1U
#define SLCD6_R1_T1_MASK                2U
#define SLCD6_R2_T2_MASK                4U
#define SLCD6_R3_T3_MASK                8U
#define SLCD6_R4_T4_MASK                16U
#define SLCD6_R5_T5_MASK                32U
#define SLCD6_R6_T6_MASK                64U
#define SLCD6_R7_T7_MASK                128U


/*** SLCD7 - SLIC Data Register 7; 0x0000007F ***/
typedef union {
  byte Byte;
  struct {
    byte R0_T0       :1;                                       /* Receive/Transmit Data Bit 0 */
...
extern volatile SLCD7STR _SLCD7 @0x0000007F;
#define SLCD7                           _SLCD7.Byte
#define SLCD7_R0_T0                     _SLCD7.Bits.R0_T0
#define SLCD7_R1_T1                     _SLCD7.Bits.R1_T1
#define SLCD7_R2_T2                     _SLCD7.Bits.R2_T2
#define SLCD7_R3_T3                     _SLCD7.Bits.R3_T3
#define SLCD7_R4_T4                     _SLCD7.Bits.R4_T4
#define SLCD7_R5_T5                     _SLCD7.Bits.R5_T5
#define SLCD7_R6_T6                     _SLCD7.Bits.R6_T6
#define SLCD7_R7_T7                     _SLCD7.Bits.R7_T7

#define SLCD7_R0_T0_MASK                1U
#define SLCD7_R1_T1_MASK                2U
#define SLCD7_R2_T2_MASK                4U
#define SLCD7_R3_T3_MASK                8U
#define SLCD7_R4_T4_MASK                16U
#define SLCD7_R5_T5_MASK                32U
#define SLCD7_R6_T6_MASK                64U
#define SLCD7_R7_T7_MASK                128U
...
#define SOPT1_IICPS0                    _SOPT1.Bits.IICPS0
#define SOPT1_IICPS1                    _SOPT1.Bits.IICPS1
#define SOPT1_SCIPS                     _SOPT1.Bits.SCIPS
#define SOPT1_STOPE                     _SOPT1.Bits.STOPE
#define SOPT1_COPT0                     _SOPT1.Bits.COPT0
#define SOPT1_COPT1                     _SOPT1.Bits.COPT1
#define SOPT1_IICPS                     _SOPT1.MergedBits.grpIICPS
#define SOPT1_COPT                      _SOPT1.MergedBits.grpCOPT

#define SOPT1_IICPS0_MASK               4U
#define SOPT1_IICPS1_MASK               8U
#define SOPT1_SCIPS_MASK                16U
#define SOPT1_STOPE_MASK                32U
#define SOPT1_COPT0_MASK                64U
#define SOPT1_COPT1_MASK                128U
#define SOPT1_IICPS_MASK                12U
#define SOPT1_IICPS_BITNUM              2U
...
typedef union {
  byte Byte;
  struct {
    byte T1CH0PS     :1;                                       /* TPM1CH0 Pin Select */
    byte T1CH1PS     :1;                                       /* TPM1CH1 Pin Select */
    byte T2CH0PS     :1;                                       /* TPM2CH0 Pin Select */
    byte T2CH1PS     :1;                                       /* TPM2CH1 Pin Select */
...
typedef union {
  byte Byte;
  struct {
    byte SEC0        :1;                                       /* Flash Security State bit 0 */
    byte SEC1        :1;                                       /* Flash Security State bit 1 */
    byte             :1; 
    byte             :1; 
    byte             :1; 
...
typedef union {
  byte Byte;
  struct {
    byte FPOP        :1;                                       /* FLASH Protect Open bit */
    ...
    byte EPS0        :1;                                       /* EEPROM Protect Select bit 0 */
    byte EPS1        :1;                                       /* EEPROM Protect Select bit 1 */
  } Bits;
  struct {
    byte         :1;
    byte grpFPS  :5;
...
#define FPROT_FPOP                      _FPROT.Bits.FPOP
...
/*** PTCSC - Port C Interrupt Status and Control Register; 0x00001854 ***/
typedef union {
  byte Byte;
  struct {
    byte PTCMOD      :1;                                       /* Port C Detection Mode */
    byte PTCIE       :1;                                       /* Port C Interrupt Enable */
    byte PTCACK      :1;                                       /* Port C Interrupt Acknowledge */
    byte PTCIF       :1;                                       /* Port C Interrupt Flag */
    byte             :1; 
    byte             :1; 
    byte             :1; 
    byte             :1; 
...
extern volatile PTCSCSTR _PTCSC @0x00001854;
#define PTCSC                           _PTCSC.Byte
#define PTCSC_PTCMOD                    _PTCSC.Bits.PTCMOD
#define PTCSC_PTCIE                     _PTCSC.Bits.PTCIE
#define PTCSC_PTCACK                    _PTCSC.Bits.PTCACK
#define PTCSC_PTCIF                     _PTCSC.Bits.PTCIF

#define PTCSC_PTCMOD_MASK               1U
#define PTCSC_PTCIE_MASK                2U
#define PTCSC_PTCACK_MASK               4U
#define PTCSC_PTCIF_MASK                8U


/*** PTCPS - Port C Interrupt Pin Select Register; 0x00001855 ***/
typedef union {
  byte Byte;
  struct {
    byte PTCPS0      :1;                                       /* Port C Interrupt Pin Select Bit 0 */
    byte PTCPS1      :1;                                       /* Port C Interrupt Pin Select Bit 1 */
    byte PTCPS2      :1;                                       /* Port C Interrupt Pin Select Bit 2 */
    byte PTCPS3      :1;                                       /* Port C Interrupt Pin Select Bit 3 */
    byte PTCPS4      :1;                                       /* Port C Interrupt Pin Select Bit 4 */
    byte PTCPS5      :1;                                       /* Port C Interrupt Pin Select Bit 5 */
    byte PTCPS6      :1;                                       /* Port C Interrupt Pin Select Bit 6 */
    byte PTCPS7      :1;                                       /* Port C Interrupt Pin Select Bit 7 */
  } Bits;
} PTCPSSTR;
extern volatile PTCPSSTR _PTCPS @0x00001855;
#define PTCPS                           _PTCPS.Byte
#define PTCPS_PTCPS0                    _PTCPS.Bits.PTCPS0
#define PTCPS_PTCPS1                    _PTCPS.Bits.PTCPS1
#define PTCPS_PTCPS2                    _PTCPS.Bits.PTCPS2
#define PTCPS_PTCPS3                    _PTCPS.Bits.PTCPS3
#define PTCPS_PTCPS4                    _PTCPS.Bits.PTCPS4
#define PTCPS_PTCPS5                    _PTCPS.Bits.PTCPS5
#define PTCPS_PTCPS6                    _PTCPS.Bits.PTCPS6
#define PTCPS_PTCPS7                    _PTCPS.Bits.PTCPS7

#define PTCPS_PTCPS0_MASK               1U
#define PTCPS_PTCPS1_MASK               2U
#define PTCPS_PTCPS2_MASK               4U
#define PTCPS_PTCPS3_MASK               8U
#define PTCPS_PTCPS4_MASK               16U
#define PTCPS_PTCPS5_MASK               32U
#define PTCPS_PTCPS6_MASK               64U
#define PTCPS_PTCPS7_MASK               128U


/*** PTCES - Port C Interrupt Edge Select Register; 0x00001856 ***/
typedef union {
  byte Byte;
  struct {
    byte PTCES0      :1;                                       /* Port C Edge Select Bit 0 */
    byte PTCES1      :1;                                       /* Port C Edge Select Bit 1 */
    byte PTCES2      :1;                                       /* Port C Edge Select Bit 2 */
    byte PTCES3      :1;                                       /* Port C Edge Select Bit 3 */
    byte PTCES4      :1;                                       /* Port C Edge Select Bit 4 */
    byte PTCES5      :1;                                       /* Port C Edge Select Bit 5 */
    byte PTCES6      :1;                                       /* Port C Edge Select Bit 6 */
    byte PTCES7      :1;                                       /* Port C Edge Select Bit 7 */
  } Bits;
} PTCESSTR;
extern volatile PTCESSTR _PTCES @0x00001856;
#define PTCES                           _PTCES.Byte
#define PTCES_PTCES0                    _PTCES.Bits.PTCES0
#define PTCES_PTCES1                    _PTCES.Bits.PTCES1
#define PTCES_PTCES2                    _PTCES.Bits.PTCES2
#define PTCES_PTCES3                    _PTCES.Bits.PTCES3
#define PTCES_PTCES4                    _PTCES.Bits.PTCES4
#define PTCES_PTCES5                    _PTCES.Bits.PTCES5
#define PTCES_PTCES6                    _PTCES.Bits.PTCES6
#define PTCES_PTCES7                    _PTCES.Bits.PTCES7

#define PTCES_PTCES0_MASK               1U
#define PTCES_PTCES1_MASK               2U
#define PTCES_PTCES2_MASK               4U
#define PTCES_PTCES3_MASK               8U
#define PTCES_PTCES4_MASK               16U
#define PTCES_PTCES5_MASK               32U
#define PTCES_PTCES6_MASK               64U
#define PTCES_PTCES7_MASK               128U
...
#define NVPROT_FPOP                     _NVPROT.Bits.FPOP
