/* Based on CPU DB MC9S12ZVH128_144, version 3.00.000 (RegistersPrg V2.33) */
/*
** ###################################################################
**     Filename  : mc9s12zvh128.h
**     Processor : MC9S12ZVH128CLQ
**     FileFormat: V2.33
**     DataSheet : Rev. 0.08 12/2011
**     Compiler  : CodeWarrior compiler
**     Date/Time : 29.6.2012, 9:37
**     Abstract  :
...
**      - 25.06.2012, V3.00.0:
**              - ADC0: Added pointers to the 24-bit registers ADC0CBP, ADC0RBP.
**              - DBG: Added pointers to the 24-bit registers DBGAA, DBGBA, DBGCA, DBGDA.
**              - MMC: Added pointer to the 24-bit register MMCPC.
**              - PIM: Corrected position of the low/high bytes in the 16-bit ports AB, CD, EF.
**              - SRAM_ECC: Added pointer to the 24-bit register ECCDPTR.
**              - SSG0: Removed 8-bit acces registers from 16-bit registers SSGPS,SSGTONE,SSGAMP,SSGAA,SSGAT,SSGAMPB.
**
...
#ifndef _MC9S12ZVH128_H
#define _MC9S12ZVH128_H
...
#define MODRR0_C0CP0RR_MASK             15U
#define MODRR0_C0CP0RR_BITNUM           0U
...
/*** PTV - Port V Data Register; 0x00000360 ***/
typedef union {
  byte Byte;
  struct {
    byte PTV0        :1;                                       /* Port V general purpose I/O data 0 */
    byte PTV1        :1;                                       /* Port V general purpose I/O data 1 */
    byte PTV2        :1;                                       /* Port V general purpose I/O data 2 */
    byte PTV3        :1;                                       /* Port V general purpose I/O data 3 */
    byte PTV4        :1;                                       /* Port V general purpose I/O data 4 */
    byte PTV5        :1;                                       /* Port V general purpose I/O data 5 */
    byte PTV6        :1;                                       /* Port V general purpose I/O data 6 */
    byte PTV7        :1;                                       /* Port V general purpose I/O data 7 */
  } Bits;
} PTVSTR;
extern volatile PTVSTR _PTV @0x00000360;
...
/*** PTIV - Port V Input Register; 0x00000361 ***/
typedef union {
  byte Byte;
  struct {
    byte PTIV0       :1;                                       /* Port V data input 0 */
    byte PTIV1       :1;                                       /* Port V data input 1 */
    byte PTIV2       :1;                                       /* Port V data input 2 */
    byte PTIV3       :1;                                       /* Port V data input 3 */
    byte PTIV4       :1;                                       /* Port V data input 4 */
    byte PTIV5       :1;                                       /* Port V data input 5 */
    byte PTIV6       :1;                                       /* Port V data input 6 */
    byte PTIV7       :1;                                       /* Port V data input 7 */
  } Bits;
} PTIVSTR;
extern volatile PTIVSTR _PTIV @0x00000361;
...
/*** DDRV - Port V Data Direction Register; 0x00000362 ***/
typedef union {
  byte Byte;
  struct {
    byte DDRV0       :1;                                       /* Port V data direction select 0 */
    byte DDRV1       :1;                                       /* Port V data direction select 1 */
    byte DDRV2       :1;                                       /* Port V data direction select 2 */
    byte DDRV3       :1;                                       /* Port V data direction select 3 */
    byte DDRV4       :1;                                       /* Port V data direction select 4 */
    byte DDRV5       :1;                                       /* Port V data direction select 5 */
    byte DDRV6       :1;                                       /* Port V data direction select 6 */
    byte DDRV7       :1;                                       /* Port V data direction select 7 */
  } Bits;
} DDRVSTR;
extern volatile DDRVSTR _DDRV @0x00000362;
...
/*** PERV - Port V Pull Device Enable Register; 0x00000363 ***/
typedef union {
  byte Byte;
  struct {
    byte PERV0       :1;                                       /* Port V pull device enable 0 */
    byte PERV1       :1;                                       /* Port V pull device enable 1 */
    byte PERV2       :1;                                       /* Port V pull device enable 2 */
    byte PERV3       :1;                                       /* Port V pull device enable 3 */
    byte PERV4       :1;                                       /* Port V pull device enable 4 */
    byte PERV5       :1;                                       /* Port V pull device enable 5 */
    byte PERV6       :1;                                       /* Port V pull device enable 6 */
    byte PERV7       :1;                                       /* Port V pull device enable 7 */
  } Bits;
} PERVSTR;
extern volatile PERVSTR _PERV @0x00000363;
...
/*** PPSV - Port V Polarity Select Register; 0x00000364 ***/
typedef union {
  byte Byte;
  struct {
    byte PPSV0       :1;                                       /* Port V pull polarity select 0 */
    byte PPSV1       :1;                                       /* Port V pull polarity select 1 */
    byte PPSV2       :1;                                       /* Port V pull polarity select 2 */
    byte PPSV3       :1;                                       /* Port V pull polarity select 3 */
    byte PPSV4       :1;                                       /* Port V pull polarity select 4 */
    byte PPSV5       :1;                                       /* Port V pull polarity select 5 */
    byte PPSV6       :1;                                       /* Port V pull polarity select 6 */
    byte PPSV7       :1;                                       /* Port V pull polarity select 7 */
  } Bits;
} PPSVSTR;
extern volatile PPSVSTR _PPSV @0x00000364;
...
/*** SRRV - Port V Slew Rate Register; 0x0000036E ***/
typedef union {
  byte Byte;
  struct {
    byte SRRV0       :1;                                       /* Slew rate port V control 0 */
    byte SRRV1       :1;                                       /* Slew rate port V control 1 */
    byte SRRV2       :1;                                       /* Slew rate port V control 2 */
    byte SRRV3       :1;                                       /* Slew rate port V control 3 */
    byte SRRV4       :1;                                       /* Slew rate port V control 4 */
    byte SRRV5       :1;                                       /* Slew rate port V control 5 */
    byte SRRV6       :1;                                       /* Slew rate port V control 6 */
    byte SRRV7       :1;                                       /* Slew rate port V control 7 */
  } Bits;
} SRRVSTR;
extern volatile SRRVSTR _SRRV @0x0000036E;
...
typedef union {
  ...
  struct {
    ...
    union {
      byte Byte;
      struct {
        byte RIDX_IMD    :7;                                       /* RES_IDX Value At Intermediate Event */
        byte             :1; 
      } Bits;
    } ADC0IMDRI_1STR;
    ...
    #define ADC0IMDRI_1_RIDX_IMD_MASK   127U
    #define ADC0IMDRI_1_RIDX_IMD_BITNUM 0U
    
  } Overlap_STR;

  struct {
    word RIDX_IMD    :7;                                       /* RES_IDX Value At Intermediate Event */
    word             :1; 
    word             :1; 
    word             :1; 
    word             :1; 
...
#define ADC0IMDRI_RIDX_IMD_MASK         127U
...
typedef union {
  byte Byte;
  struct {
    byte CPDR0       :1;                                       /* Port CP Data Bit */
    byte CPDR1       :1;                                       /* Port CP Data Bit */
    byte             :1; 
    byte             :1; 
    byte             :1; 
    byte             :1; 
    byte             :1; 
    byte CPDR7       :1;                                       /* Port CP Data Bit */
  } Bits;
  struct {
    byte grpCPDR :2;
    byte         :1;
...
typedef union {
  ...
  struct {
    ...
    byte             :1; 
    byte             :1; 
    byte WUPE        :1;                                       /* Wake-Up Receiver Enable */
...
/*** MCCC4 - Motor Controller Control Register 4; 0x00000A54 ***/
typedef union {
  byte Byte;
  struct {
    byte CD0         :1;                                       /* PWM Channel Delay */
...
extern volatile MCCC4STR _MCCC4 @0x00000A54;
...
/*** MCCC5 - Motor Controller Control Register 5; 0x00000A55 ***/
typedef union {
  byte Byte;
  struct {
    byte CD0         :1;                                       /* PWM Channel Delay */
...
extern volatile MCCC5STR _MCCC5 @0x00000A55;
...
/*** MCCC6 - Motor Controller Control Register 6; 0x00000A56 ***/
typedef union {
  byte Byte;
  struct {
    byte CD0         :1;                                       /* PWM Channel Delay */
...
extern volatile MCCC6STR _MCCC6 @0x00000A56;
...
/*** MCCC7 - Motor Controller Control Register 7; 0x00000A57 ***/
typedef union {
  byte Byte;
  struct {
    byte CD0         :1;                                       /* PWM Channel Delay */
...
extern volatile MCCC7STR _MCCC7 @0x00000A57;
...
/*** MCDC4 - Motor Controller Period Register 4; 0x00000A68 ***/
typedef union {
  word Word;
   /* Overlapped registers: */
  struct {
    /*** MCDC4_FAST - Motor Controller Period Register 4 access with FAST bit = 1; 0x00000A68 ***/
    union {
      byte Byte;
      struct {
        byte D2          :1;                                       /* Motor Controller Duty Cycle, bit 2 */
...
extern volatile MCDC4STR _MCDC4 @0x00000A68;
...
/*** MCDC5 - Motor Controller Period Register 5; 0x00000A6A ***/
typedef union {
  word Word;
   /* Overlapped registers: */
  struct {
    /*** MCDC5_FAST - Motor Controller Period Register 5 access with FAST bit = 1; 0x00000A6A ***/
    union {
      byte Byte;
      struct {
        byte D2          :1;                                       /* Motor Controller Duty Cycle, bit 2 */
...
extern volatile MCDC5STR _MCDC5 @0x00000A6A;
...
/*** MCDC6 - Motor Controller Period Register 6; 0x00000A6C ***/
typedef union {
  word Word;
   /* Overlapped registers: */
  struct {
    /*** MCDC6_FAST - Motor Controller Period Register 6 access with FAST bit = 1; 0x00000A6C ***/
    union {
      byte Byte;
      struct {
        byte D2          :1;                                       /* Motor Controller Duty Cycle, bit 2 */
...
extern volatile MCDC6STR _MCDC6 @0x00000A6C;
...
/*** MCDC7 - Motor Controller Period Register 7; 0x00000A6E ***/
typedef union {
  word Word;
   /* Overlapped registers: */
  struct {
    /*** MCDC7_FAST - Motor Controller Period Register 7 access with FAST bit = 1; 0x00000A6E ***/
    union {
      byte Byte;
      struct {
        byte D2          :1;                                       /* Motor Controller Duty Cycle, bit 2 */
...
extern volatile MCDC7STR _MCDC7 @0x00000A6E;
...
/*** RTZ2CTL - SSD2 Return-to-Zero Control Register; 0x00000AA0 ***/
typedef union {
  byte Byte;
  struct {
    byte STEP        :2;                                       /* Full Step State */
...
extern volatile RTZ2CTLSTR _RTZ2CTL @0x00000AA0;
...
/*** MDC2CTL - SSD2 Modulus Down Counter Control Register; 0x00000AA1 ***/
typedef union {
  byte Byte;
  struct {
    byte AOVIE       :1;                                       /* Accumulator Overflow Interrupt Enable */
...
extern volatile MDC2CTLSTR _MDC2CTL @0x00000AA1;
...
/*** SSD2CTL - SSD2 Stepper Stall Detector Control Register; 0x00000AA2 ***/
typedef union {
  byte Byte;
  struct {
    byte ACLKS       :2;                                       /* Accumulator Sample Frequency Select */
...
extern volatile SSD2CTLSTR _SSD2CTL @0x00000AA2;
...
/*** SSD2FLG - SSD2 Stepper Stall Detector Flag Register; 0x00000AA3 ***/
typedef union {
  byte Byte;
  struct {
    byte AOVIF       :1;                                       /* Accumulator Overflow Interrupt Flag */
...
extern volatile SSD2FLGSTR _SSD2FLG @0x00000AA3;
...
/*** MDC2CNT - SSD2 Modulus Down-Counter Count Register; 0x00000AA4 ***/
typedef union {
  word Word;
  struct {
    word MDCCNT      :16;                                      /* Modulus Down Counter */
...
extern volatile MDC2CNTSTR _MDC2CNT @0x00000AA4;
...
/*** ITG2ACC - SSD2 Integration Accumulator Register; 0x00000AA6 ***/
typedef union {
  word Word;
  struct {
    word ITGACC      :16;                                      /* Integration Accumulator */
...
extern volatile ITG2ACCSTR _ITG2ACC @0x00000AA6;
...
/*** RTZ3CTL - SSD3 Return-to-Zero Control Register; 0x00000AB0 ***/
typedef union {
  byte Byte;
  struct {
    byte STEP        :2;                                       /* Full Step State */
...
extern volatile RTZ3CTLSTR _RTZ3CTL @0x00000AB0;
...
/*** MDC3CTL - SSD3 Modulus Down Counter Control Register; 0x00000AB1 ***/
typedef union {
  byte Byte;
  struct {
    byte AOVIE       :1;                                       /* Accumulator Overflow Interrupt Enable */
...
extern volatile MDC3CTLSTR _MDC3CTL @0x00000AB1;
...
/*** SSD3CTL - SSD3 Stepper Stall Detector Control Register; 0x00000AB2 ***/
typedef union {
  byte Byte;
  struct {
    byte ACLKS       :2;                                       /* Accumulator Sample Frequency Select */
...
extern volatile SSD3CTLSTR _SSD3CTL @0x00000AB2;
...
/*** SSD3FLG - SSD3 Stepper Stall Detector Flag Register; 0x00000AB3 ***/
typedef union {
  byte Byte;
  struct {
    byte AOVIF       :1;                                       /* Accumulator Overflow Interrupt Flag */
...
extern volatile SSD3FLGSTR _SSD3FLG @0x00000AB3;
...
/*** MDC3CNT - SSD3 Modulus Down-Counter Count Register; 0x00000AB4 ***/
typedef union {
  word Word;
  struct {
    word MDCCNT      :16;                                      /* Modulus Down Counter */
...
extern volatile MDC3CNTSTR _MDC3CNT @0x00000AB4;
...
/*** ITG3ACC - SSD3 Integration Accumulator Register; 0x00000AB6 ***/
typedef union {
  word Word;
  struct {
    word ITGACC      :16;                                      /* Integration Accumulator */
...
extern volatile ITG3ACCSTR _ITG3ACC @0x00000AB6;
...
typedef union {
  ...
  struct {
    ...
    byte             :1; 
    byte             :1; 
    byte CLKSRC      :1;                                       /* RTC Clock Source Selection */
    byte             :1; 
  } Bits;
} RTCCTL2STR;
...
#define RTCCTL2_CLKSRC_MASK             64U
...
typedef union {
  word Word;
  struct {
    word PS          :11;                                      /* SSG Decay or attack Selection */
    word             :1; 
    word             :1; 
    word             :1; 
    word             :1; 
...
#define SSG0AMPB_AT                     _SSG0AMPB.Bits.AT

#define SSG0AMPB_AT_MASK                2047U
#define SSG0AMPB_AT_BITNUM              0U
...
#define SSG0PSH                          SSG0PS
#define SSG0PSH_PS                       SSG0PS_PS
#define SSG0PSH_PS_MASK                  SSG0PS_PS_MASK
#define SSG0PSH_PS_BITNUM                SSG0PS_PS_BITNUM
#define SSG0PSL                          This_symb_has_been_depreciated
#define SSG0TONEH                        SSG0TONE
#define SSG0TONEH_TONE                   SSG0TONE_TONE
#define SSG0TONEH_TONE_MASK              SSG0TONE_TONE_MASK
#define SSG0TONEH_TONE_BITNUM            SSG0TONE_TONE_BITNUM
#define SSG0TONEL                        This_symb_has_been_depreciated
#define SSG0AMPH                         SSG0AMP
#define SSG0AMPH_AMP                     SSG0AMP_AMP
#define SSG0AMPH_AMP_MASK                SSG0AMP_AMP_MASK
#define SSG0AMPH_AMP_BITNUM              SSG0AMP_AMP_BITNUM
#define SSG0AMPL                         This_symb_has_been_depreciated
#define SSG0AAH                          SSG0AA
#define SSG0AAH_AA                       SSG0AA_AA
#define SSG0AAH_AA_MASK                  SSG0AA_AA_MASK
#define SSG0AAH_AA_BITNUM                SSG0AA_AA_BITNUM
#define SSG0AAL                          This_symb_has_been_depreciated
#define SSG0ATH                          SSG0AT
#define SSG0ATH_AT                       SSG0AT_AT
#define SSG0ATH_AT_MASK                  SSG0AT_AT_MASK
#define SSG0ATH_AT_BITNUM                SSG0AT_AT_BITNUM
#define SSG0ATL                          This_symb_has_been_depreciated
#define SSG0AMPBH                        SSG0AMPB
#define SSG0AMPBH_AT                     SSG0AMPB_AT
#define SSG0AMPBH_AT_MASK                SSG0AMPB_AT_MASK
#define SSG0AMPBH_AT_BITNUM              SSG0AMPB_AT_BITNUM
#define SSG0AMPBL                        This_symb_has_been_depreciated
