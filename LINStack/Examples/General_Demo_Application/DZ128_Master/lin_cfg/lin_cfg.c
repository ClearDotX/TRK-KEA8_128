...
const l_u8 LI0_SporadicControlFrame_info_data[1] ={
...
const lin_frame_struct lin_frame_tbl[LIN_NUM_OF_FRMS] ={
   ...
   ,{ LIN_FRM_UNCD, 5, LIN_RES_SUB, 1, 1, 1 , (l_u8*)0 }
  
   ,{ LIN_FRM_UNCD, 3, LIN_RES_SUB, 6, 2, 1 , (l_u8*)0 }
...
volatile l_u8 lin_frame_updating_flag_tbl[LIN_NUM_OF_FRMS] = {0, 0, 0, 0, 0, 0};
...
l_u8 LI0_lin_configuration_RAM[LI0_LIN_SIZE_OF_CFG]= {0x00, 0x01, 0x02, 0x03, 0x3C, 0x3D, 0xFF ,0xFF};


const l_u16  LI0_lin_configuration_ROM[LI0_LIN_SIZE_OF_CFG]= {0x0000, 0x01, 0x02, 0x03, 0x3C, 0x3D, 0xFF ,0xFFFF};
...
const lin_schedule_data LI0_NormalTable_data[3] = {
   ...
   {LI0_PotentiometerInfo, 10, 0}
  

   , {LI0_LightSensorInfo, 10, 0}
  
   , {LI0_SporadicControlFrame, 4, 0}
