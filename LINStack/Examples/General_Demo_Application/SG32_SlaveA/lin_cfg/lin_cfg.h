...
* @version   1.0
*
* @date      Wed Feb 27 13:22:01 ICT 2019
*
...
#define LIN_BYTE_OFFSET_LI0_Cluster2PotentiometerA    2U
#define LIN_BIT_OFFSET_LI0_Cluster2PotentiometerA    0U
#define LIN_SIGNAL_SIZE_LI0_Cluster2PotentiometerA    8U
#define LIN_FLAG_BYTE_OFFSET_LI0_Cluster2PotentiometerA    2U
#define LIN_FLAG_BIT_OFFSET_LI0_Cluster2PotentiometerA    0U


#define LIN_BYTE_OFFSET_LI0_Cluster2LightSensorA    3U
...
#define LIN_BYTE_OFFSET_LI0_Cluster2SlaveAError    4U
#define LIN_BIT_OFFSET_LI0_Cluster2SlaveAError    0U
#define LIN_SIGNAL_SIZE_LI0_Cluster2SlaveAError    1U
#define LIN_FLAG_BYTE_OFFSET_LI0_Cluster2SlaveAError    2U
#define LIN_FLAG_BIT_OFFSET_LI0_Cluster2SlaveAError    2U
...
#define LIN_FLAG_BYTE_OFFSET_LI0_Cluster2SlaveAInfo             2
#define LIN_FLAG_BIT_OFFSET_LI0_Cluster2SlaveAInfo              0
...
/* static access macros for signal LI0_Cluster2SlaveAError */

 
#define l_bool_rd_LI0_Cluster2SlaveAError() \
    (LIN_TEST_BIT(lin_pFrameBuf[LIN_BYTE_OFFSET_LI0_Cluster2SlaveAError], \
    LIN_BIT_OFFSET_LI0_Cluster2SlaveAError))

#define l_bool_wr_LI0_Cluster2SlaveAError(A) \
    {(A) ? \
    (LIN_SET_BIT(lin_pFrameBuf[LIN_BYTE_OFFSET_LI0_Cluster2SlaveAError], \
    LIN_BIT_OFFSET_LI0_Cluster2SlaveAError)):\
    (LIN_CLEAR_BIT(lin_pFrameBuf[LIN_BYTE_OFFSET_LI0_Cluster2SlaveAError], \
    LIN_BIT_OFFSET_LI0_Cluster2SlaveAError));\
    LIN_CLEAR_BIT(lin_flag_handle_tbl[LIN_FLAG_BYTE_OFFSET_LI0_Cluster2SlaveAError],\
         LIN_FLAG_BIT_OFFSET_LI0_Cluster2SlaveAError);}
...
#define l_flg_tst_LI0_Cluster2SlaveAError_flag() \
         LIN_TEST_BIT(lin_flag_handle_tbl[LIN_FLAG_BYTE_OFFSET_LI0_Cluster2SlaveAError],\
         LIN_FLAG_BIT_OFFSET_LI0_Cluster2SlaveAError)
#define l_flg_clr_LI0_Cluster2SlaveAError_flag() \
         LIN_CLEAR_BIT(lin_flag_handle_tbl[LIN_FLAG_BYTE_OFFSET_LI0_Cluster2SlaveAError],\
         LIN_FLAG_BIT_OFFSET_LI0_Cluster2SlaveAError)
...
/* Frame flag APIs */
 ...
 #define l_flg_tst_LI0_Cluster2SlaveAInfo_flag() \
          lin_frame_flag_tbl[LI0_Cluster2SlaveAInfo]
 #define l_flg_clr_LI0_Cluster2SlaveAInfo_flag() \
          lin_frame_flag_tbl[LI0_Cluster2SlaveAInfo] = 0
