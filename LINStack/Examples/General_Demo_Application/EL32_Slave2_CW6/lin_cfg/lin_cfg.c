...
const l_signal_handle LI0_response_error_signal = LI0_Cluster1Slave2Error;
...
l_u8    lin_pFrameBuf[LIN_FRAME_BUF_SIZE] =
{
  ...
  ,0x00 /* 2 : 00000000 */ /* start of frame LI0_Cluster1Slave2Info */
...
l_u8    lin_flag_handle_tbl[LIN_FLAG_BUF_SIZE] =
{
  ...
  ,0xFF /* 2: start of flag frame LI0_Cluster1Slave2Info */
...
l_u8 lin_configuration_RAM[LIN_SIZE_OF_CFG]= {0x00, 0x05, 0x04, 0x07, 0x3C, 0x3D ,0xFF};


const l_u16  lin_configuration_ROM[LIN_SIZE_OF_CFG]= {0x00, 0x05, 0x04, 0x07, 0x3C, 0x3D ,0xFFFF};

/***************************************** Node Attribute*****************************************/

l_u8 lin_configured_NAD = 0x03;    /*<configured_NAD>*/
const l_u8 lin_initial_NAD    =0x0C;    /*<initial_NAD>*/
const lin_product_id product_id = {0x0020, 0x0003, 0x0002 };  /* {<supplier_id>,<function_id>,<variant>} */
const l_signal_handle response_error =  LI0_Cluster1Slave2Error;
const l_u8 num_frame_have_esignal = 1;                                 /*number of frame contain error signal*/
const l_u16 lin_response_error_byte_offset[1] = {LIN_BYTE_OFFSET_LI0_Cluster1Slave2Error};                  /*<interface_name>_< response_error>*/
const l_u8 lin_response_error_bit_offset[1] = {LIN_BIT_OFFSET_LI0_Cluster1Slave2Error};                  /*<interface_name>_< response_error>*/
