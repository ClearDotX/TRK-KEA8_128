...
const l_signal_handle LI0_response_error_signal = LI0_MotorLinError;
...
l_u8    lin_pFrameBuf[LIN_FRAME_BUF_SIZE] =
{
  ...
  0xff /* 0 : 11111111 */ /* start of frame LI0_MotorControl */
  ...
  ,0x05 /* 8 : 00000101 */ /* start of frame LI0_MotorQuery */
  ...
  ,0x80 /* 13 : 10000000 */ /* start of frame LI0_MotorState_Cycl */
  ...
  ,0x42 /* 21 : 01000010 */ /* start of frame LI0_MotorState_Event */
...
l_u8    lin_flag_handle_tbl[LIN_FLAG_BUF_SIZE] =
{
  ...
  0xFF /* 0: start of flag frame LI0_MotorControl */



  ,0xFF /* 1: start of flag frame LI0_MotorQuery */


  ,0xFF /* 2: start of flag frame LI0_MotorState_Cycl */


  ,0xFF /* 3: start of flag frame LI0_MotorState_Event */
...
const l_u8 LI0_ETF_MotorState_Cycl_info_data = LI0_MotorState_Cycl ;  /* frame data */

const l_u8 LI0_ETF_MotorState_Event_info_data = LI0_MotorState_Event ;  /* frame data */
...
const lin_frame_struct lin_frame_tbl[LIN_NUM_OF_FRMS] ={
   ...
   ,{ LIN_FRM_UNCD, 5, LIN_RES_SUB, 8, 1, 1 , (l_u8*)0 }
  
   ,{ LIN_FRM_UNCD, 8, LIN_RES_PUB, 13, 2, 1 , (l_u8*)&LI0_response_error_signal }
  
   ,{ LIN_FRM_UNCD, 3, LIN_RES_PUB, 21, 3, 1 , (l_u8*)0 }
  
   ,{ LIN_FRM_EVNT, 3, LIN_RES_PUB, 0, 0, 0 , (l_u8*)&LI0_ETF_MotorState_Event_info_data }
  
   ,{ LIN_FRM_EVNT, 8, LIN_RES_PUB, 0, 0, 0 , (l_u8*)&LI0_ETF_MotorState_Cycl_info_data }
...
l_u8 lin_configuration_RAM[LIN_SIZE_OF_CFG]= {0x00, 0x04, 0x05, 0x00, 0x02, 0x38, 0x37, 0x3C, 0x3D ,0xFF};


const l_u16  lin_configuration_ROM[LIN_SIZE_OF_CFG]= {0x00, 0x04, 0x05, 0x00, 0x02, 0x38, 0x37, 0x3C, 0x3D ,0xFFFF};
...
const l_signal_handle response_error =  LI0_MotorLinError;
const l_u8 num_frame_have_esignal = 1;                                 /*number of frame contain error signal*/
const l_u16 lin_response_error_byte_offset[1] = {LIN_BYTE_OFFSET_LI0_MotorLinError};                  /*<interface_name>_< response_error>*/
const l_u8 lin_response_error_bit_offset[1] = {LIN_BIT_OFFSET_LI0_MotorLinError};                  /*<interface_name>_< response_error>*/
