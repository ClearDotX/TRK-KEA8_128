...
* @version   1.0
*
* @date      Thu Mar 07 09:54:50 ICT 2019
*
...
#define _LI0_DIAG_NUMBER_OF_SERVICES_    12

#define LI0_DIAGSRV_READ_BY_IDENTIFIER_ORDER    0

#define LI0_DIAGSRV_WRITE_DATA_BY_IDENTIFIER_ORDER    1

#define LI0_DIAGSRV_SESSION_CONTROL_ORDER    2

#define LI0_DIAGSRV_IO_CONTROL_BY_IDENTIFIER_ORDER    3

#define LI0_DIAGSRV_FAULT_MEMORY_READ_ORDER    4

#define LI0_DIAGSRV_FAULT_MEMORY_CLEAR_ORDER    5

#define LI0_DIAGSRV_ASSIGN_FRAME_ID_RANGE_ORDER    6

#define LI0_DIAGSRV_ASSIGN_NAD_ORDER    7

#define LI0_DIAGSRV_CONDITIONAL_CHANGE_NAD_ORDER    8

#define LI0_DIAGSRV_SAVE_CONFIGURATION_ORDER    9

#define LI0_DIAGSRV_ASSIGN_FRAME_IDENTIFIER_ORDER    10

#define LI0_DIAGSRV_READ_DATA_BY_IDENTIFIER_ORDER    11
