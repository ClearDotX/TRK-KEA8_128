...
l_u8    lin_pFrameBuf[LIN_FRAME_BUF_SIZE] =
{
  ...
  ,0xfc /* 8 : 11111100 */ /* start of frame LI0_Motor1Control */


  ,0x05 /* 9 : 00000101 */ /* start of frame LI0_Motor1State_Cycl */
  ...
  ,0x76 /* 15 : 01110110 */ /* start of frame LI0_Motor1State_Event */
...
const lin_frame_struct lin_frame_tbl[LIN_NUM_OF_FRMS] ={
   ...
   ,{ LIN_FRM_UNCD, 1, LIN_RES_SUB, 8, 1, 1 , (l_u8*)0 }
  
   ,{ LIN_FRM_UNCD, 6, LIN_RES_PUB, 9, 2, 1 , (l_u8*)&LI0_response_error_signal }
  
   ,{ LIN_FRM_UNCD, 3, LIN_RES_PUB, 15, 3, 1 , (l_u8*)0 }
